...
export default [
  ...
  {
    path: '/blog/archive',
    component: ComponentCreator('/blog/archive', '672'),
    exact: true
  },
  {
    path: '/blog/tags',
  ...
  {
    path: '/blog/tags/blog',
    component: ComponentCreator('/blog/tags/blog', '5f3'),
    exact: true
  },
  {
    path: '/blog/tags/welcome',
    component: ComponentCreator('/blog/tags/welcome', '02c'),
    exact: true
  },
  {
    path: '/blog/welcome',
    component: ComponentCreator('/blog/welcome', 'd77'),
    exact: true
  },
  {
    path: '/docs/tags',
    component: ComponentCreator('/docs/tags', '520'),
    exact: true
  },
  {
    path: '/docs/tags/availability',
    component: ComponentCreator('/docs/tags/availability', 'ee9'),
    exact: true
  },
  {
    path: '/docs/tags/begriff',
    component: ComponentCreator('/docs/tags/begriff', '168'),
    exact: true
  },
  {
    path: '/docs/tags/begriffe',
    component: ComponentCreator('/docs/tags/begriffe', '52c'),
    exact: true
  },
  {
    path: '/docs/tags/bom',
    component: ComponentCreator('/docs/tags/bom', '4b2'),
    exact: true
  },
  {
    path: '/docs/tags/bpm',
    component: ComponentCreator('/docs/tags/bpm', '6bb'),
    exact: true
  },
  {
    path: '/docs/tags/compliance',
    component: ComponentCreator('/docs/tags/compliance', 'e9a'),
    exact: true
  },
  {
    path: '/docs/tags/dokumentation',
    component: ComponentCreator('/docs/tags/dokumentation', 'e3b'),
    exact: true
  },
  {
    path: '/docs/tags/glossar',
    component: ComponentCreator('/docs/tags/glossar', '6b0'),
    exact: true
  },
  {
    path: '/docs/tags/handbuch',
    component: ComponentCreator('/docs/tags/handbuch', 'a9d'),
    exact: true
  },
  {
    path: '/docs/tags/im',
    component: ComponentCreator('/docs/tags/im', '1e2'),
    exact: true
  },
  {
    path: '/docs/tags/it-begriff',
    component: ComponentCreator('/docs/tags/it-begriff', 'c8c'),
    exact: true
  },
  {
    path: '/docs/tags/it-dokumentation',
    component: ComponentCreator('/docs/tags/it-dokumentation', 'b66'),
    exact: true
  },
  {
    path: '/docs/tags/it-glossar',
    component: ComponentCreator('/docs/tags/it-glossar', 'de8'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/docs/tags/metadaten', 'e18'),
    exact: true
  },
  {
  ...
  {
    path: '/docs/tags/pm',
    component: ComponentCreator('/docs/tags/pm', '1ea'),
    exact: true
  },
  {
    path: '/docs/tags/prozessmanagement',
    component: ComponentCreator('/docs/tags/prozessmanagement', '3b7'),
    exact: true
  },
  {
  ...
  {
    path: '/docs/tags/sw',
    component: ComponentCreator('/docs/tags/sw', '2b6'),
    exact: true
  },
  {
    path: '/docs/tags/technische-dokumentation',
    component: ComponentCreator('/docs/tags/technische-dokumentation', 'eae'),
    exact: true
  },
  {
    path: '/docs/tags/unternehmensexternen-regelwerken',
    component: ComponentCreator('/docs/tags/unternehmensexternen-regelwerken', '4f9'),
    exact: true
  },
  {
    path: '/docs/tags/unternehmensinternen-regelwerke',
    component: ComponentCreator('/docs/tags/unternehmensinternen-regelwerke', '8d9'),
    exact: true
  },
  {
    path: '/docs/tags/verfugbarkeit',
    component: ComponentCreator('/docs/tags/verfugbarkeit', 'a42'),
    exact: true
  },
  {
    path: '/docs/tags/web',
    component: ComponentCreator('/docs/tags/web', '18d'),
    exact: true
  },
  {
    path: '/docs/tags/web-browser',
    component: ComponentCreator('/docs/tags/web-browser', 'f36'),
    exact: true
  },
  {
    path: '/docs/tags/web-client',
    component: ComponentCreator('/docs/tags/web-client', 'a71'),
    exact: true
  },
  {
    path: '/docs/tags/webseite',
    component: ComponentCreator('/docs/tags/webseite', 'eef'),
    exact: true
  },
  {
    path: '/docs/tags/website',
    component: ComponentCreator('/docs/tags/website', 'f3b'),
    exact: true
  },
  {
    path: '/docs/tags/wm',
    component: ComponentCreator('/docs/tags/wm', '06b'),
    exact: true
  },
  {
    path: '/Dokumentenlenkung',
    component: ComponentCreator('/Dokumentenlenkung', '509'),
    exact: true
  },
  {
    path: '/search',
    component: ComponentCreator('/search', 'bf6'),
    exact: true
  },
  {
    path: '/docs',
    ...
    routes: [
      ...
      {
        path: '/docs/Glossar/D-Glossar/Dokumentenlandkarten/Dokumentationslandkarte-IT',
        component: ComponentCreator('/docs/Glossar/D-Glossar/Dokumentenlandkarten/Dokumentationslandkarte-IT', 'b04'),
        exact: true,
        sidebar: "Sidebar10"
      },
      {
      ...
      {
        path: '/docs/Glossar/D-Glossar/Dokumentenverwaltung',
        component: ComponentCreator('/docs/Glossar/D-Glossar/Dokumentenverwaltung', 'c51'),
        exact: true,
        sidebar: "Sidebar10"
      },
      {
      ...
      {
        path: '/docs/Glossar/P-Glossar/Prozesssteckbrief',
        component: ComponentCreator('/docs/Glossar/P-Glossar/Prozesssteckbrief', '0ff'),
        exact: true,
        sidebar: "Sidebar10"
      },
      {
  ...
  {
    path: '/',
    component: ComponentCreator('/', '5c4'),
    exact: true
  },
  {
    path: '*',
